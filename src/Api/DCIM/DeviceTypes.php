...
class DeviceTypes extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/device-types/", $params);
    }
    ...
    {
        return $this->patch("/dcim/device-types/", $params);
    }
    ...
    {
        return $this->delete("/dcim/device-types/", $params);
    }
    ...
    {
        return $this->patch("/dcim/device-types/" . $id . "/", $params);
    }
