...
class FrontPorts extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/front-ports/", $params);
    }
    ...
    {
        return $this->patch("/dcim/front-ports/", $params);
    }
    ...
    {
        return $this->delete("/dcim/front-ports/", $params);
    }
    ...
    {
        return $this->patch("/dcim/front-ports/" . $id . "/", $params);
    }
