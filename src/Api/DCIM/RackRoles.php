...
class RackRoles extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/rack-roles/", $params);
    }
    ...
    {
        return $this->patch("/dcim/rack-roles/", $params);
    }
    ...
    {
        return $this->delete("/dcim/rack-roles/", $params);
    }
    ...
    {
        return $this->patch("/dcim/rack-roles/" . $id . "/", $params);
    }
