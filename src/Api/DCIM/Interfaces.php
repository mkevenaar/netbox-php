...
class Interfaces extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/interfaces/", $params);
    }
    ...
    {
        return $this->patch("/dcim/interfaces/", $params);
    }
    ...
    {
        return $this->delete("/dcim/interfaces/", $params);
    }
    ...
    {
        return $this->patch("/dcim/interfaces/" . $id . "/", $params);
    }
