...
class ConsolePorts extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/console-ports/", $params);
    }
    ...
    {
        return $this->patch("/dcim/console-ports/", $params);
    }
    ...
    {
        return $this->delete("/dcim/console-ports/", $params);
    }
    ...
    {
        return $this->patch("/dcim/console-ports/" . $id . "/", $params);
    }
