...
class DeviceBays extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/device-bays/", $params);
    }
    ...
    {
        return $this->patch("/dcim/device-bays/", $params);
    }
    ...
    {
        return $this->delete("/dcim/device-bays/", $params);
    }
    ...
    {
        return $this->patch("/dcim/device-bays/" . $id . "/", $params);
    }
