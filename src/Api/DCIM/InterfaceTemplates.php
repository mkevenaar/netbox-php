...
class InterfaceTemplates extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/interface-templates/", $params);
    }
    ...
    {
        return $this->patch("/dcim/interface-templates/", $params);
    }
    ...
    {
        return $this->delete("/dcim/interface-templates/", $params);
    }
    ...
    {
        return $this->patch("/dcim/interface-templates/" . $id . "/", $params);
    }
