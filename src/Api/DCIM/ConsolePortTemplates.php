...
class ConsolePortTemplates extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/console-port-templates/", $params);
    }
    ...
    {
        return $this->patch("/dcim/console-port-templates/", $params);
    }
    ...
    {
        return $this->delete("/dcim/console-port-templates/", $params);
    }
    ...
    {
        return $this->patch("/dcim/console-port-templates/" . $id . "/", $params);
    }
