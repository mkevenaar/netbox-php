...
class RearPorts extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/rear-ports/", $params);
    }
    ...
    {
        return $this->patch("/dcim/rear-ports/", $params);
    }
    ...
    {
        return $this->delete("/dcim/rear-ports/", $params);
    }
    ...
    {
        return $this->patch("/dcim/rear-ports/" . $id . "/", $params);
    }
