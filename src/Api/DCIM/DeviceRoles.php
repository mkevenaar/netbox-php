...
class DeviceRoles extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/device-roles/", $params);
    }
    ...
    {
        return $this->patch("/dcim/device-roles/", $params);
    }
    ...
    {
        return $this->delete("/dcim/device-roles/", $params);
    }
    ...
    {
        return $this->patch("/dcim/device-roles/" . $id . "/", $params);
    }
