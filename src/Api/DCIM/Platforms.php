...
class Platforms extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/platforms/", $params);
    }
    ...
    {
        return $this->patch("/dcim/platforms/", $params);
    }
    ...
    {
        return $this->delete("/dcim/platforms/", $params);
    }
    ...
    {
        return $this->patch("/dcim/platforms/" . $id . "/", $params);
    }
