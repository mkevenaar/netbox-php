...
class FrontPortTemplates extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/front-port-templates/", $params);
    }
    ...
    {
        return $this->patch("/dcim/front-port-templates/", $params);
    }
    ...
    {
        return $this->delete("/dcim/front-port-templates/", $params);
    }
    ...
    {
        return $this->patch("/dcim/front-port-templates/" . $id . "/", $params);
    }
