...
class PowerOutletTemplates extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/power-outlet-templates/", $params);
    }
    ...
    {
        return $this->patch("/dcim/power-outlet-templates/", $params);
    }
    ...
    {
        return $this->delete("/dcim/power-outlet-templates/", $params);
    }
    ...
    {
        return $this->patch("/dcim/power-outlet-templates/" . $id . "/", $params);
    }
