...
class Devices extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/devices/", $params);
    }
    ...
    {
        return $this->patch("/dcim/devices/", $params);
    }
    ...
    {
        return $this->delete("/dcim/devices/", $params);
    }
    ...
    {
        return $this->post("/dcim/devices/" . $id . "/render-config/", $params);
    }
}
