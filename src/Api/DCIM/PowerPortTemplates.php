...
class PowerPortTemplates extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/power-port-templates/", $params);
    }
    ...
    {
        return $this->patch("/dcim/power-port-templates/", $params);
    }
    ...
    {
        return $this->delete("/dcim/power-port-templates/", $params);
    }
    ...
    {
        return $this->patch("/dcim/power-port-templates/" . $id . "/", $params);
    }
