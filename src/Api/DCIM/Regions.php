...
class Regions extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/regions/", $params);
    }
    ...
    {
        return $this->patch("/dcim/regions/", $params);
    }
    ...
    {
        return $this->delete("/dcim/regions/", $params);
    }
    ...
    {
        return $this->patch("/dcim/regions/" . $id . "/", $params);
    }
