...
class PowerPorts extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/power-ports/", $params);
    }
    ...
    {
        return $this->patch("/dcim/power-ports/", $params);
    }
    ...
    {
        return $this->delete("/dcim/power-ports/", $params);
    }
    ...
    {
        return $this->patch("/dcim/power-ports/" . $id . "/", $params);
    }
