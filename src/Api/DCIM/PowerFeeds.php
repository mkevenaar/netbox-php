...
class PowerFeeds extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/power-feeds/", $params);
    }
    ...
    {
        return $this->patch("/dcim/power-feeds/", $params);
    }
    ...
    {
        return $this->delete("/dcim/power-feeds/", $params);
    }
    ...
    {
        return $this->patch("/dcim/power-feeds/" . $id . "/", $params);
    }
