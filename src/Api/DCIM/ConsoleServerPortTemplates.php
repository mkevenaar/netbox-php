...
class ConsoleServerPortTemplates extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/console-server-port-templates/", $params);
    }
    ...
    {
        return $this->patch("/dcim/console-server-port-templates/", $params);
    }
    ...
    {
        return $this->delete("/dcim/console-server-port-templates/", $params);
    }
    ...
    {
        return $this->patch("/dcim/console-server-port-templates/" . $id . "/", $params);
    }
