...
class PowerPanels extends AbstractApi
{
    ...
    {
        return $this->put("/dcim/power-panels/", $params);
    }
    ...
    {
        return $this->patch("/dcim/power-panels/", $params);
    }
    ...
    {
        return $this->delete("/dcim/power-panels/", $params);
    }
    ...
    {
        return $this->patch("/dcim/power-panels/" . $id . "/", $params);
    }
