...
class ClusterTypes extends AbstractApi
{
    ...
    {
        return $this->put("/virtualization/cluster-types/", $params);
    }
    ...
    {
        return $this->patch("/virtualization/cluster-types/", $params);
    }
    ...
    {
        return $this->delete("/virtualization/cluster-types/", $params);
    }
